...
export const TURKEY_CITIES: City[] = [
  ...
  {
    name: "Diyarbakır",
    districts: ["Bağlar", "Bismil", "Çermik", "Çınar", "Dicle", "Eğil", "Ergani", "Hani", "Hazro", "Kayapınar", "Kocaköy", "Kulp", "Lice", "Silvan", "Sur", "Yenişehir"]
  },
  {
    name: "Düzce",
  ...
  {
    name: "Tekirdağ",
    districts: ["Çerkezköy", "Çorlu", "Ergene", "Hayrabolu", "Kapakli", "Malkara", "Marmaraereğlisi", "Muratlı", "Saray", "Süleymanpaşa", "Şarköy"]
  },
  {
    name: "Tokat",
...
// Helper function to get districts by city name
