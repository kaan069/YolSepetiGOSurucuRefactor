...
export default function TowTruckPhotoSection({
  ...
  const pickImageFromCamera = async () => {
    ...
    if (permissionResult.granted === false) {
      Alert.alert('Izin Gerekli', 'Kamera erisim izni vermelisiniz.');
      return;
    }
        ...
        <View>
          <View style={styles.photoPickerContainer}>
            ...
            >
              ...
              <Text style={styles.photoPickerText}>Kameradan Cek</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.photoPickerButton}
              onPress={pickImageFromGallery}
            >
              ...
              <Text style={styles.photoPickerText}>Galeriden Sec</Text>
            </TouchableOpacity>
          </View>
          <Button
            mode="outlined"
