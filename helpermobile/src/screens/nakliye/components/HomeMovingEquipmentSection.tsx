...
// Nakliye donanımları
export const homeMovingEquipmentOptions = [
  'Ambalaj Malzemesi',
  'Koruma Örtüsü',
  'Taşıma Askısı',
...
interface HomeMovingEquipmentSectionProps {
  selectedEquipment: string[];
  onToggleEquipment: (equipment: string) => void;
}

export default function HomeMovingEquipmentSection({
  selectedEquipment,
  onToggleEquipment,
}: HomeMovingEquipmentSectionProps) {
  return (
    <View style={styles.formSection}>
      ...
      <View style={styles.chipContainer}>
        {homeMovingEquipmentOptions.map((equipment) => (
          <Chip
            key={equipment}
